...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'JANGAN LUPA BILANG TERIMA KASIH',
			error: {
        ...
        const zero = fs.readFileSync ('./zeroyt7/zero1.png')
...
"thumbnail": fs.readFileSync('./zeroyt7/zero1.png')
}
...
img = fs.readFileSync('./zeroyt7/zero1.png')
...
break
	...
	*- JANGAN SPAM*
	*- GUNAIN DENGAN BIJAK*
	*- SEMAKIN SPAM SEMAKIN HABIS LIMIT KALIAN*
	...
	*_ALLAH SWT*
	*_BAPAK & EMAK*
	*_TEMAN, SAHABAT, DAN KERABAT*
	*YANG CUMA NIKMATIN GW YG PUSING*
	*_ZERO YT*
	*_LOLHUMAN*
	*_SC CREATOR LAENNYA*
	*_PENYEDIA APIKEY*
...
costum(buffer, sticker, Verived, `BISA KALI DONASI WARMA BOT`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `BISA KALI DONASI WARMA BOT`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'BILANG APA KE WARMA BOT'})
fs.unlinkSync(ran)
})
break
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'JANGAN LUPA TERIMA KASIH KE WARMA BOT'})
break
case 'tiktok':
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
ini_url = args[0]
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'JANGAN LUPA UCAP TERIMA KASIH'})
break
case 'tiktokmusic':
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'JANGAN LUPA UCAP TERIMA KASIH'})
break
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'JANGAN LUPA BILANG TERIMA KASIH'})
})
break
case 'chiisaihentai':
case 'trap':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'JANGAN LUPA BILANG TERIMA KASIH'})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'JANGAN LUPA BILANG TERIMA KASIH'})
break
case 'asupanhijaber':
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'JANGAN LUPA BILANG TERIMA KASIH'})
break
case 'cecanmalaysia':
...
zeroyt7.sendMessage(`6282122193227@s.whatsapp.net`, options, text, { quoted: ftrol })
...
sendButton(from, "GOPAY : 082122193227 (Sukma Sanjaya)", faketeks, but, mek)
break
case 'dana':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "DANA : 082122193227 (Sukma Sanjaya)", faketeks, but, mek)
break
case 'ovo':
but = [
{ buttonId: `${prefix}done`, buttonText: { displayText: 'DONE' }, type: 1 }
]
sendButton(from, "OVO : 082122193227 (Sukma Sanjaya)", faketeks, but, mek)
break
case 'donasi':
...
break
case 'dmml':
qris = fs.readFileSync('./zeroyt7/zero1.png')
trans = `©Created : Warma Bot`
